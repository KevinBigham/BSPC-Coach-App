...
function TemplatesScreen() {
  ...
  const filtered =
    filterGroup === 'All' ? templates : templates.filter((t) => t.group === filterGroup);
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item: group }) => (
          ...
          >
            <Text
              style={[styles.filterChipText, filterGroup === group && styles.filterChipTextActive]}
            >
              {group}
            </Text>
          </TouchableOpacity>
...
export default withScreenErrorBoundary(TemplatesScreen, 'TemplatesScreen');
