...
function ImportScreen() {
  ...
  const headerRight = (
    <TouchableOpacity onPress={() => router.push('/import/history')}>
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
          <View style={styles.resultCard}>
            ...
            <View style={styles.resultRow}>
              ...
              <View style={styles.resultStat}>
                <Text style={[styles.resultNum, { color: colors.textSecondary }]}>
                  {result.skipped}
                </Text>
      ...
      <>
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
          <View style={styles.previewHeader}>
            ...
            <View style={styles.previewStat}>
              <Text style={[styles.previewNum, { color: colors.error }]}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.hint}>
            Expected columns: firstName, lastName, group, gender, dateOfBirth, usaSwimmingId,
...
export default withScreenErrorBoundary(ImportScreen, 'ImportScreen');
